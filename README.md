...
Open the `testing.ipynb` notebook to see usage examples, comparisons, and plots.
...
```bash
jupyter nbconvert --to notebook --execute --inplace --ExecutePreprocessor.timeout=600 testing.ipynb
```
